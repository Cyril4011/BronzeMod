...
import net.mcreator.cyrilbronze.init.CyrilBronzeModTabs;
import net.mcreator.cyrilbronze.init.CyrilBronzeModItems;
import net.mcreator.cyrilbronze.init.CyrilBronzeModFeatures;
import net.mcreator.cyrilbronze.init.CyrilBronzeModBlocks;
...
public class CyrilBronzeMod implements ModInitializer {
	public static final Logger LOGGER = LogManager.getLogger(CyrilBronzeMod.class);
	public static final String MODID = "cyril_bronze";

	@Override
	public void onInitialize() {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		LOGGER.info("Initializing CyrilBronzeMod");
		CyrilBronzeModTabs.load();
		CyrilBronzeModFeatures.load();
		CyrilBronzeModBlocks.load();
		CyrilBronzeModItems.load();
		tick();
