package net.mcreator.cyrilbronze.mixin;
...
public abstract class EquipmentLayerRendererMixin {
	...
	public void renderLayers(EquipmentClientInfo.LayerType layerType, ResourceKey<EquipmentAsset> resourceKey, Model model, ItemStack itemStack, PoseStack poseStack, MultiBufferSource multiBufferSource, int i, ResourceLocation resourceLocation,
			CallbackInfo ci) {
		if (CyrilBronzeModArmorModels.ARMOR_MODELS.containsKey(itemStack.getItem())) {
			CyrilBronzeModArmorModels.ArmorModel armorModel = CyrilBronzeModArmorModels.ARMOR_MODELS.get(itemStack.getItem());
